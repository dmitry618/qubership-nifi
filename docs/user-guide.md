...
| PutGeneratedRecord           | migration-nifi-processors-open   | Generates Records based on the processor properties and sends them to a destination specified by a Record Destination Service, i.e. record sink.  <br/>                                                                                                                                         |
