...
/**
 * Strategy interface for collecting component descriptors from a specific NiFi version.
 * Returns a list of maps each containing "type" (String) and "propertyDescriptors" (JsonNode).
 */
public interface NiFiVersionStrategy {

    /**
     * Collects component descriptors for the given kind.
     *
